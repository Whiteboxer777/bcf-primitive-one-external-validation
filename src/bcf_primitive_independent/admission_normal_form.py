"""Independent ANF compiler/evaluator built on the independent semantic core."""
...
from .semantic_core import Node, Profile, normalize
...
def evaluate_anf(anf: AdmissionNormalForm, profile: Profile, request: dict[str, Any]) -> dict[str, Any]:
    from .semantic_core import evaluate_profile, EvalContext, atom_outcome, select_scope, deep_get
