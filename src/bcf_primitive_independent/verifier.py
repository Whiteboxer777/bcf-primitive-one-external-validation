...
from bcf_trust_kernel.contract import VERDICT_SCHEMA, bundle_contract
from bcf_trust_kernel.governance import evaluate_authority, verify_signature
from .semantic_core import compare_profiles, evaluate_profile, extract_decisive_core, is_satisfiable, minimize_profile, normalize, parse_profile, Profile
from .common import digest_data, load_json, sha256_file, PRIMITIVE_IDENTITY
from bcf_trust_kernel.refusal import REFUSAL_SCHEMA, PERMIT_SCHEMA, VERIFICATION_RESULT_SCHEMA
...
from bcf_trust_kernel.witness_certificate import attach_witness_certificate, WITNESS_CERTIFICATE_SCHEMA
...
def verify_bundle_independent(bundle_dir: str | Path) -> dict[str, Any]:
