"""Independent compiled-backend compiler/evaluator built on the independent ANF line."""
...
from .semantic_core import Profile, parse_node
...
def _atom_truth_map(compiled: CompiledBackend, request: dict[str, Any]) -> dict[str, bool]:
    from .semantic_core import EvalContext, atom_outcome
